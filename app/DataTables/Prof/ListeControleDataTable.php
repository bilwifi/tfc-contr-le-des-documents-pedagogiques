...
namespace App\DataTables\Prof;

use App\Models\Controles_document;
use Yajra\DataTables\Services\DataTable;

class ListeControleDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', function($query){
                return 
                '<a href="'.route('professeur.get_controle',[$query->idcontroles_documents]) .'" class="edit-modal btn btn-info">
    ...
    public function query(Controles_document $model)
    {
        return $model->JoinProf()
                      ...
                      ->where('professeurs.idprofesseurs',$this->idprofesseurs)
                      ->get([
    ...
    {
        return 'Prof/ListeControle_' . date('YmdHis');
    }
}
